    ...
    <section className="relative overflow-hidden bg-[#F8FBFF] py-20 sm:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.article
                ...
                className="group rounded-2xl border border-[#D9E6FA] bg-white p-5 shadow-[0_8px_22px_rgba(23,105,255,0.05)] transition duration-300 hover:-translate-y-1 hover:border-[#1769FF]/40 hover:shadow-[0_16px_32px_rgba(23,105,255,0.12)]"
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-2xl font-bold tracking-tight text-[#061A45]">
                    {stat.value}
                  </span>
                </div>

                <h3 className="mt-5 text-sm font-bold text-[#061A45]">
                  {stat.label}
                </h3>
        ...
        <motion.div
          ...
          className="mt-8 rounded-2xl border border-[#D9E6FA] bg-white p-5 shadow-[0_8px_22px_rgba(23,105,255,0.05)] sm:p-6"
        >
            ...
            <div className="flex flex-wrap items-center gap-2">
              {deliverySteps.map((step, index) => (
                <div key={step} className="flex items-center gap-2">
                  <div className="rounded-full border border-[#D9E6FA] bg-[#F8FBFF] px-3 py-2 text-xs font-bold text-[#061A45]">
                  ...
                  {index !== deliverySteps.length - 1 && (
                    <ArrowRight className="h-3.5 w-3.5 text-[#1769FF]/50" />
                  )}
                </div>
              ))}
            </div>
