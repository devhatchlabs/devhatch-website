...
const mainServices: MainService[] = [
  {
    ...
    description:
      "Custom AI chatbots for websites and support channels that answer questions, qualify leads, and guide customers forward.",
    icon: MessageSquare,
    steps: ["Customer Query", "AI Assistant", "Helpful Reply"],
    outcomes: [
      "24/7 customer support",
      "Lead capture and qualification",
      "Website support workflows",
    ],
...
const additionalServices: AdditionalService[] = [
  ...
  {
    title: "FYP Project Development",
    description:
      "Complete final year project support including idea selection, UI/UX, development, AI modules, documentation, and deployment.",
    icon: GraduationCap,
  },
  {
    title: "Portfolio Websites",
    description:
      "Modern portfolio websites for students, developers, freelancers, and professionals to showcase skills and projects.",
    icon: Globe,
  },
];
    ...
    <main className="relative min-h-screen overflow-hidden bg-white pb-20 pt-24 sm:pt-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-5 flex items-center gap-2 text-xs font-medium text-[#61708A]">
          <Link
            href="/"
            className="transition-colors duration-300 hover:text-[#1769FF]"
          >
            Home
          </Link>
        ...
        <section className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="max-w-[560px]">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 rounded-xl border px-3 py-2.5 text-left text-xs font-semibold transition-all duration-300 ${
                      isActive
                        ? "border-[#1769FF] bg-[#1769FF] text-white shadow-[0_7px_0_rgba(104,157,255,0.30),0_18px_32px_rgba(23,105,255,0.22)] hover:-translate-y-1 hover:border-[#159FE8] hover:shadow-[0_9px_0_rgba(105,190,255,0.34),0_22px_40px_rgba(23,105,255,0.28)]"
            ...
            >
              <Link
                href="/contact"
                className="group mt-7 inline-flex items-center gap-2 rounded-full border border-[#1769FF] bg-[#1769FF] px-5 py-3 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:border-[#159FE8] hover:bg-[#159FE8] hover:shadow-[0_8px_0_rgba(108,176,255,0.30),0_18px_34px_rgba(23,105,255,0.28)]"
              >
          ...
          >
            ...
            <div className="group overflow-hidden rounded-2xl border border-[#D9E6FA] bg-white transition-all duration-300 hover:-translate-y-1 hover:border-[#1769FF]/70 hover:shadow-[0_11px_0_rgba(128,171,255,0.26),0_28px_52px_rgba(23,105,255,0.18)]">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <motion.div
                      ...
                      className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#1769FF]/10 text-[#1769FF] transition-all duration-300 group-hover:-translate-y-1 group-hover:bg-[#1769FF] group-hover:text-white group-hover:shadow-[0_6px_0_rgba(111,160,255,0.28),0_14px_24px_rgba(23,105,255,0.20)]"
                    >
          ...
          <div className="mt-7 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {additionalServices.map((service) => {
              ...
              return (
                <article
                  key={service.title}
                  className="group rounded-2xl border border-[#D9E6FA] bg-white p-5 transition-all duration-300 hover:-translate-y-2 hover:border-[#1769FF]/70 hover:shadow-[0_8px_0_rgba(130,170,255,0.22),0_22px_40px_rgba(23,105,255,0.16)]"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#EEF5FF] text-[#1769FF] transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-110 group-hover:bg-[#1769FF] group-hover:text-white group-hover:shadow-[0_5px_0_rgba(117,164,255,0.24),0_12px_22px_rgba(23,105,255,0.18)]">
                    <Icon className="h-5 w-5" strokeWidth={1.9} />
                  </div>

                  <h3 className="mt-4 text-sm font-bold text-[#061A45] transition-colors duration-300 group-hover:text-[#1769FF]">
                    {service.title}
                  </h3>
                  ...
                  <span className="mt-4 block h-px w-0 bg-gradient-to-r from-[#1769FF] via-[#159FE8] to-[#6D4AFF] transition-all duration-300 group-hover:w-16" />
                </article>
              );
            })}
          </div>
        ...
        <section className="group mt-16 overflow-hidden rounded-3xl border border-[#1769FF]/35 bg-gradient-to-br from-[#061A45] via-[#0A2D70] to-[#1769FF] px-6 py-9 text-center transition-all duration-300 hover:-translate-y-1 hover:border-[#7FAAFF] hover:shadow-[0_10px_0_rgba(84,137,255,0.26),0_28px_56px_rgba(6,26,69,0.30)] sm:px-10">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#14C8E8] transition-transform duration-300 group-hover:-translate-y-0.5">
          ...
          <Link
            href="/contact"
            className="group/button mt-6 inline-flex items-center gap-2 rounded-full border border-white/80 bg-white px-6 py-3 text-sm font-bold text-[#1769FF] transition-all duration-300 hover:-translate-y-1 hover:bg-[#EEF5FF] hover:shadow-[0_7px_0_rgba(148,188,255,0.28),0_18px_32px_rgba(6,26,69,0.26)]"
          >
